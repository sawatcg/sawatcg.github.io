...
galleryresstatus:
  - image_path: /assets/images/first-set-teaser/Hypnos_R.png
  - image_path: /assets/images/first-set-teaser/MedidationRetrat.png
galleryAxiom1:
  - image_path: /assets/images/first-set-teaser/Tinselbot_R.png
  - image_path: /assets/images/first-set-teaser/LightTurnsGreen.png
  - image_path: /assets/images/first-set-teaser/VarkoOvervolt.png
galleryAxiom2:
  - image_path: /assets/images/first-set-teaser/YuriLocomotiveEngineer.png
  - image_path: /assets/images/first-set-teaser/TheWatchpost.png
galleryBravos1:
  - image_path: /assets/images/first-set-teaser/NullMantle.png
  - image_path: /assets/images/first-set-teaser/Glatshyn.png
  - image_path: /assets/images/first-set-teaser/BravosOutlandTrooper_R.png
galleryBravos2:
  - image_path: /assets/images/first-set-teaser/Minikhlut.png
  - image_path: /assets/images/first-set-teaser/Zird_R.png
galleryLyra1:
  - image_path: /assets/images/first-set-teaser/Tiresias.png
  - image_path: /assets/images/first-set-teaser/PalmReadinTent_R.png
galleryLyra2:
  - image_path: /assets/images/first-set-teaser/Sindbab.png
  - image_path: /assets/images/first-set-teaser/Reynardthefox_R.png
galleryMuna1:
  - image_path: /assets/images/first-set-teaser/AloeStriata_R.png
  - image_path: /assets/images/first-set-teaser/PullTheWool.png
galleryMuna2:
  - image_path: /assets/images/first-set-teaser/ManaTithe.png
  - image_path: /assets/images/first-set-teaser/ThornrootGrove.png
galleryOrdis1:
  - image_path: /assets/images/first-set-teaser/TheCounterfeiter.png
  - image_path: /assets/images/first-set-teaser/CrowdedOut.png
galleryOrdis2:
  - image_path: /assets/images/first-set-teaser/Niobe.png
  - image_path: /assets/images/first-set-teaser/ThebAt.png
galleryYzmir1:
  - image_path: /assets/images/first-set-teaser/Eavesdropper.png
...
{% include gallery id="galleryExhaust" %}
...
{% include gallery id="galleryrestoken" %}
...
{% include gallery id="galleryresstatus" %}
...
Below is a brief teaser of what each faction has to offer. For every faction, you will find three cards showcasing set-specific mechanics or archetypes and two more generic cards supporting already existing ones. Keep in mind that this is only a partial glimpse of the set as a whole, and that more surprises remain to be revealed.
...
{% include gallery id="galleryAxiom1" %}

{% include gallery id="galleryAxiom2" %}
...
{% include gallery id="galleryOrdis1" %}

{% include gallery id="galleryOrdis2" %}
...
{% include gallery id="galleryYzmir1" %}
...
{% include gallery id="galleryYzmir2" %}
